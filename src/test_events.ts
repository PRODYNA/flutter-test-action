...
type Event = StartEvent | AllSuitesEvent | SuiteEvent | DebugEvent | GroupEvent | TestStartEvent | MessageEvent | ErrEvent | TestDoneEvent | DoneEvent | { type: "non-exhaustive" };
